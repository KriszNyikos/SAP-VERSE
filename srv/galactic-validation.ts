...
export const validateSpaceFarerUpdate = async (req: cds.Request<SpaceFarer>) => {
      ...
      const spaceSuitRows = await SELECT.from("galactic.adventure.SpaceSuitColors").columns("code") as { code: string }[];
